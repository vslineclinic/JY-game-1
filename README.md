...
- `OPENAI_MODEL`: 사용할 OpenAI 모델명입니다. 기본값은 `gpt-4o-mini`입니다.
...
### OPENAI_API_KEY가 없다고 나와요

`.streamlit/secrets.toml` 파일이 있는지, 키 이름이 정확히 `OPENAI_API_KEY`인지 확인하세요.
